        ...
        <div className="bg-[#F5F5F7] w-full rounded-2xl shadow-md py-4 px-6">
          ...
          <div>
            ...
            <div className="flex items-center justify-center w-full mt-2 mb-4">
              <div className={`flex flex-col items-center justify-center w-full h-48 border-2 py-10 rounded-2xl overflow-hidden bg-gray-50 shadow ${isDataEmpty || editMode ? "border-gray-300" : "border-gray-50"}`}>
                <div dangerouslySetInnerHTML={{ __html: formData.map }} />
              </div>
            </div>
